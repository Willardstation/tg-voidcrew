...
/obj/machinery/power/shuttle_engine/fueled/burn_engine(percentage = 100)
	. = ..()
...
/obj/machinery/power/shuttle_engine/fueled/return_fuel()
	. = ..()
...
/obj/machinery/power/shuttle_engine/fueled/return_fuel_cap()
	. = ..()
	var/datum/gas_mixture/air_contents = loc.return_air()
	if(!air_contents)
		return
...
/obj/machinery/power/shuttle_engine/fueled/proc/consume_fuel(amount)
	var/datum/gas_mixture/air_contents = loc.return_air()
	if(!air_contents)
		return
...
///CO2
/obj/machinery/power/shuttle_engine/fueled/expulsion
